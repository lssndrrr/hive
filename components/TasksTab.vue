<template>
    <div class="space-y-6">
        <section>
            <h3
                class="text-sm font-semibold uppercase text-[#A86523]/80 mb-2 tracking-wider"
            >
                To do
            </h3>
            <div class="space-y-2">
                ...
                <div
                    ...
                    class="text-center text-sm text-[#A86523] py-4"
                >
                    No tasks here.
                </div>
            </div>
        ...
        <section>
            <h3
                class="text-sm font-semibold uppercase text-[#A86523] mb-2 tracking-wider"
            >
                In progress
            </h3>
            <div class="space-y-2">
                ...
                <div
                    ...
                    class="text-center text-sm text-[#A86523]/60 py-4"
                >
                    No tasks here.
                </div>
            </div>
        ...
        <section>
            ...
            <div class="space-y-2">
                ...
                <div
                    v-if="!overdueTasks || overdueTasks.length === 0"
                    class="text-center text-sm text-[#A86523]/60 py-4"
                >
                    No tasks here.
                </div>
    ...
    [
        {
            ...
            click: (event: Event) => {
                ...
                console.log('Edit task:', task.id) /* Emit edit event */
            },
        },
    ],
    [
        {
            ...
            click: (event: Event) => {
                event.stopPropagation()
                console.log('Delete task:', task.id) /* Emit delete event */
            },
        },
    ],
]
